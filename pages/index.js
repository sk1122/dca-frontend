    ...
    <div className="flex flex-col items-center justify-center w-1/2 h-full  py-16 bg-white rounded-2xl shadow-lg ">
      <div>
        <h2 className="text-2xl font-light leading-snug text-center tracking-wider">
          ...
          <input type="number" className='border-b-2 border-dashed border-secondary px-2' style={{
            width: '100px'
          }} />
          ...
          <select name="time" id="time" className='text-secondary border-b-2 border-secondary border-dashed'>
          ...
          <select name="transaction" id="transaction" className='text-secondary border-b-2 border-secondary border-dashed'>
          ...
          <select name="years" id="years" className='text-secondary border-b-2 border-secondary border-dashed'>
  ...
  return (
    <div className="bg-ternanay">
      ...
      <main className={styles.main}>
        ...
        <p className='text-secondary text-2xl my-2'>The non-custodial way to systematically invest into crypto assets</p>
        <Link href={"/dashboard"}>
          <button className='bg-primary text-white font-bold rounded-md px-10 py-2 my-10'>ENTER APP</button>
        </Link>
